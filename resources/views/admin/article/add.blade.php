            ...
            <tr>
                ...
                <td>
                    <script id="editor" type="text/plain" name="art_content"
                            style="width:1024px;height:200px;"></script>
                </td>
            </tr>

            <th></th>
            <td>
                <input type="button" id="addArt" value="提交">
            ...
            $.post(
                    ...
                    function (data) {
                        ...
                        if(data.state == '11'){
                            ...
                            var jieshu = "";
                            for(var a=0;a<=data.msg.length-1;a++){
                                var li ="<li>"+data.msg[a]+"</li>";
                                 jieshu+= li;
                                //$(".mark").children().append(li);
                            }
                            layer.msg(jieshu)
                        }
                    }
