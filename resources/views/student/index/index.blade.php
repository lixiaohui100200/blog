...
<head>
  ...
  <!--dashboard calendar-->
  <link href="/resources/views/student/style/css/clndr.css" rel="stylesheet">

  <!--Morris Chart CSS -->
  <link rel="stylesheet" href="/resources/views/student/style/js/morris-chart/morris.css">
    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="left-side-inner">
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li class="menu-list"><a href=""><i class="fa fa-laptop"></i> <span>学生模块</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="{{url('student/list')}}"> 学籍信息</a></li>
                        <li><a href="../模板/boxed_view.html"> Boxed Page</a></li>
                        <li><a href="../模板/leftmenu_collapsed_view.html"> Sidebar Collapsed</a></li>
                        <li><a href="../模板/horizontal_menu.html"> Horizontal Menu</a></li>
                    </ul>
                </li>
                <li class="menu-list"><a href=""><i class="fa fa-book"></i> <span>UI Elements</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="../模板/general.html"> General</a></li>
                        <li><a href="../模板/buttons.html"> Buttons</a></li>
                        <li><a href="../模板/tabs-accordions.html"> Tabs & Accordions</a></li>
                        <li><a href="../模板/typography.html"> Typography</a></li>
                        <li><a href="../模板/slider.html"> Slider</a></li>
                        <li><a href="../模板/panels.html"> Panels</a></li>
                    </ul>
                </li>
                <li class="menu-list"><a href=""><i class="fa fa-cogs"></i> <span>Components</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="../模板/grids.html"> Grids</a></li>
                        <li><a href="../模板/gallery.html"> Media Gallery</a></li>
                        <li><a href="../模板/calendar.html"> Calendar</a></li>
                        <li><a href="../模板/tree_view.html"> Tree View</a></li>
                        <li><a href="../模板/nestable.html"> Nestable</a></li>

                    </ul>
                </li>

                <li><a href="../模板/fontawesome.html"><i class="fa fa-bullhorn"></i> <span>Fontawesome</span></a></li>

                <li class="menu-list"><a href=""><i class="fa fa-envelope"></i> <span>Mail</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="../模板/mail.html"> Inbox</a></li>
                        <li><a href="../模板/mail_compose.html"> Compose Mail</a></li>
                        <li><a href="../模板/mail_view.html"> View Mail</a></li>
                    </ul>
                </li>

                <li class="menu-list"><a href=""><i class="fa fa-tasks"></i> <span>Forms</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="../模板/form_layouts.html"> Form Layouts</a></li>
                        <li><a href="../模板/form_advanced_components.html"> Advanced Components</a></li>
                        <li><a href="../模板/form_wizard.html"> Form Wizards</a></li>
                        <li><a href="../模板/form_validation.html"> Form Validation</a></li>
                        <li><a href="../模板/editors.html"> Editors</a></li>
                        <li><a href="../模板/inline_editors.html"> Inline Editors</a></li>
                        <li><a href="../模板/pickers.html"> Pickers</a></li>
                        <li><a href="../模板/dropzone.html"> Dropzone</a></li>
                        <li><a href="http://www.weidea.net"> More</a></li>
                    </ul>
                </li>
                <li class="menu-list"><a href=""><i class="fa fa-bar-chart-o"></i> <span>Charts</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="../模板/flot_chart.html"> Flot Charts</a></li>
                        <li><a href="../模板/morris.html"> Morris Charts</a></li>
                        <li><a href="../模板/chartjs.html"> Chartjs</a></li>
                        <li><a href="../模板/c3chart.html"> C3 Charts</a></li>
                    </ul>
                </li>
                <li class="menu-list"><a href="#"><i class="fa fa-th-list"></i> <span>Data Tables</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="../模板/basic_table.html"> Basic Table</a></li>
                        <li><a href="../模板/dynamic_table.html"> Advanced Table</a></li>
                        <li><a href="../模板/responsive_table.html"> Responsive Table</a></li>
                        <li><a href="../模板/editable_table.html"> Edit Table</a></li>
                    </ul>
                </li>

                <li class="menu-list"><a href="#"><i class="fa fa-map-marker"></i> <span>Maps</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="../模板/google_map.html"> Google Map</a></li>
                        <li><a href="../模板/vector_map.html"> Vector Map</a></li>
                    </ul>
                </li>
                <li class="menu-list"><a href=""><i class="fa fa-file-text"></i> <span>Extra Pages</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="../模板/profile.html"> Profile</a></li>
                        <li><a href="../模板/invoice.html"> Invoice</a></li>
                        <li><a href="../模板/pricing_table.html"> Pricing Table</a></li>
                        <li><a href="../模板/timeline.html"> Timeline</a></li>
                        <li><a href="../模板/blog_list.html"> Blog List</a></li>
                        <li><a href="../模板/blog_details.html"> Blog Details</a></li>
                        <li><a href="../模板/directory.html"> Directory </a></li>
                        <li><a href="../模板/chat.html"> Chat </a></li>
                        <li><a href="../模板/404.html"> 404 Error</a></li>
                        <li><a href="../模板/500.html"> 500 Error</a></li>
                        <li><a href="../模板/registration.html"> Registration Page</a></li>
                        <li><a href="../模板/lock_screen.html"> Lockscreen </a></li>
                    </ul>
                </li>
                <li><a href="../模板/login.html"><i class="fa fa-sign-in"></i> <span>Login Page</span></a></li>
...
<!--easy pie chart-->
<script src="/resources/views/student/style/js/easypiechart/jquery.easypiechart.js"></script>
<script src="/resources/views/student/style/js/easypiechart/easypiechart-init.js"></script>
...
<!--icheck -->
<script src="/resources/views/student/style/js/iCheck/jquery.icheck.js"></script>
<script src="/resources/views/student/style/js/icheck-init.js"></script>

<!-- jQuery Flot Chart-->
<script src="/resources/views/student/style/js/flot-chart/jquery.flot.js"></script>
<script src="/resources/views/student/style/js/flot-chart/jquery.flot.tooltip.js"></script>
<script src="/resources/views/student/style/js/flot-chart/jquery.flot.resize.js"></script>


<!--Morris Chart-->
<script src="/resources/views/student/style/js/morris-chart/morris.js"></script>
<script src="/resources/views/student/style/js/morris-chart/raphael-min.js"></script>

<!--Calendar-->
<script src="/resources/views/student/style/js/calendar/clndr.js"></script>
<script src="/resources/views/student/style/js/calendar/evnt.calendar.init.js"></script>
<script src="/resources/views/student/style/js/calendar/moment-2.2.1.js"></script>
...
<!--Dashboard Charts-->
<script src="/resources/views/student/style/js/dashboard-chart-init.js"></script>
